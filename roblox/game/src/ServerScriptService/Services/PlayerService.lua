...
--- Standard Roblox leaderstats (shows automatically in the player list) so
--- viewers who join as players have a visible score to chase — Kills from
--- WeaponService/CreatureFactory, Points weighted by what they killed.
function PlayerService.setupLeaderstats(player: Player)
